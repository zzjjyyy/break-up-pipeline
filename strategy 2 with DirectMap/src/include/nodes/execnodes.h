 ...
 */
/*
* Edited by zhaojy20 in 1965-1986.
*/
#ifndef EXECNODES_H
#define EXECNODES_H
 ...
 * ----------------
 */
typedef struct DirectMapState
{
	JoinState js;				/* its first field is NodeTag */
	TupleTableSlot* dm_NullInnerTupleSlot;
	int dm_JoinState;
	unsigned int dm_outerattr;
	unsigned int dm_innerattr;
	Datum* dm_Map;
	double mapsize;
	unsigned int nDatumperTuple;
	MemoryContext mapCxt;
	MemoryContext mapStrCxt;
	unsigned int offset;
} DirectMapState;
